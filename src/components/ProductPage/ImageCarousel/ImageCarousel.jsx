...
import FirmnessScale from "../FirmnessScale/FirmnessScaleDesktop";
          ...
          <LargeImgWrap>
            {nodes.map(({ key, data, state: { opacity } }) => (
              <div key={key} style={{ opacity, position: "relative" }}>
                ...
                >
                  <GatsbyImage
                    image={getImage(ImagesArray[data])}
                    alt={
