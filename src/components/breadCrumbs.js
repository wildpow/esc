  ...
  return (
    <Fragment>
      ...
      {props.next2 && (
        <div>
          <Crumbs
            to={`/${props.next.toLowerCase()}/${props.next2.toLowerCase()}`}
          >
            {capitalizeFirstLetter(props.next2)}
          </Crumbs>
      ...
      <Location>
        {props.error ? (
          <Crumbs
            to={`/${props.next.toLowerCase()}/${props.next2.toLowerCase()}/${props.here.toLowerCase()}`}
          >
            {props.here}
          </Crumbs>
        ) : (
