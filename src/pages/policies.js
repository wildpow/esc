  ...
  <Layout>
    <MainArticle>
      ...
      <P>
        ...
        Because of this, we ask that you sleep on your new mattress for a
      ...
      <P>
        ...
        way damaged by you under this guarantee. Do not remove the Law Label
        from your mattress or foundation, doing so will void your 90 Day Comfort
        Guarantee. Please be aware that our Comfort Guarantee does not cover
        clearance merchandise, floor models, warranty exchanges, furniture,
        adjustable bases, pillows, mattress protectors, or other accessories.
      ...
      <P>
        ...
        damage caused during delivery. Please make sure there is a clear path
        from the door to the area you would like your mattress set placed.
        Removal is limited to number of pieces being delivered and is limited to
        mattresses and foundations. Frames, furniture, waterbeds, etc. cannot be
        removed.
      </P>
      <P>
