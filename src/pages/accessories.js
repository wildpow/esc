  ...
  <Main>
    ...
    <AccWrapper>
      ...
      <InfoWrapper>
        ...
        <P>
          ...
          Protect-A-Bed, Sealy, and Stearns & Foster to others. Offering a large
          selection of heights and firmnesses to compliment any sleeping style
          and body type.
        </P>
      </InfoWrapper>
    </AccWrapper>
    <AccWrapper>
      ...
      <InfoWrapperReversed>
        <Img2 src={Sheets} />
        <P>
          We proudly carry the full collection of DreamFit sheets. Ranging from
          a basic microfiber to luxurious Micro Tencel. All DreamFit sheets are
          of the upmost quality and are guaranteed not to &quot;pop off&quot;
          your mattress during the night.
        </P>
      </InfoWrapperReversed>
    </AccWrapper>
    <AccWrapper>
      ...
      <InfoWrapper>
        <Img src={Protector} />
        <P>
          We carry a comprehensive selection of mattress protection options from
          Protect-A-Bed, the industry leader in mattress protection. With
