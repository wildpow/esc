...
const SharedLinkStyles = css`
  color: ${props => props.theme.oldStyles.newColor1};
  ...
  white-space: nowrap;
  :hover {
    color: ${props => props.theme.oldStyles.newColor2};
    transform: scale(1.04);
    text-decoration: underline;
    text-decoration-color: ${props => props.theme.oldStyles.newColor1};
  }
`;
...
export const Top = styled.div`
  ...
  font-weight: 300;
  background-color: ${props => props.theme.oldStyles.mainColor2};
  box-shadow: ${props => props.theme.oldStyles.newBoxShadow};
  text-shadow: ${props => props.theme.oldStyles.newTextShadow};
  color: ${props => props.theme.oldStyles.newColor1};
  /* display: flex;
  flex-direction: row;
